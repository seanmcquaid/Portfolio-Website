...
const About = props => {
    ...
    return(
        <AboutPageContainer id="aboutPage" data-testid="aboutPage">
            ...
            <Aux>
                <LeftContainer>
                    <HeaderText id="aboutPageHeader" data-testid="aboutPageHeader">About</HeaderText>
                ...
                <RightContainer>
                    <Headshot src={trumpetHeadshot} alt="trumpetHeadshot" id="bioHeadshot" data-testid="bioHeadshot"/>
                </RightContainer>
            </Aux>}
        </AboutPageContainer>
    );
